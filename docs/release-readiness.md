...
| `3` | Aligner verrous, revalidations et invariants ligne/utilisateur/incident. | `CON-01` à `CON-04`, `AUTH-01` | Lots 1 et 2 | IN_PROGRESS |
...
| `3B` | Verrouiller et revalider les lignes, puis geler leurs champs structurels tant qu'un incident actif les référence. | `CON-01`, `CON-02`, `CON-03` | IN_PROGRESS |
