/**
 * Identifiants et données du jeu E2E.
 *
 * Doivent rester synchronisés avec backend/scripts/seedE2E.ts — c'est la même
 * vérité, dupliquée ici parce que le test (frontend) et le seed (backend) sont
 * deux processus distincts qui ne partagent pas de module.
 */
